...
set -ex
bash run_project.sh -i tests/integration/input.json -s tests/integration/config/samples.json -r tests/runs/local/ -f tests/data/fastq -d /scratch/p313191//apps/
